...
<b>In this model, we're using the difference between body temp and 41 degrees, which is the mean body temp for birds > 28 days old. 
```{r}
diffTemp.mdl <- lmer(sat1~age + residuals + tempDiff + (1|family), data = mc)
