...
annotate_figure(climate.wrap, top = "Climate during the breeding season (12 March-31 May)")
cowplot::save_plot("BreedingClimate.wrap.png", BreedingClimate.wrap, base_height = 8, base_width = 6)
```
