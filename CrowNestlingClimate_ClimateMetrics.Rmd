...
#Code check
c(mean=mean(clim.df[1:11,11]),metric=clim.df[1,21])
#mean() calculation should match metric
```
...
#Code check
c(mean=mean(clim.df[12:22,11]), metric=clim.df[1,22])#mean() calculation should match metric
```
...
#Code check
c(mean=mean(clim.df[1:19,11]), metric=clim.df[19,23]) #mean() calculation should match metric
```
<br>
...
#Code check
c(mean=mean(clim.df[1:11,12]),metric=clim.df[1,24])
#mean() calculation should match metric
```
...
#Code check
c(mean=mean(clim.df[12:22,12]), metric=clim.df[1,25])#mean() calculation should match metric
```
...
#Code check
c(mean=mean(clim.df[1:19,12]), metric=clim.df[19,26]) #mean() calculation should match metric
```
<br>
...
#Code check
c(mean=mean(clim.df[1:11,13]),metric=clim.df[1,27])
#mean() calculation should match metric
```
...
#Code check
c(mean=mean(clim.df[12:22,13]), metric=clim.df[1,28])#mean() calculation should match metric
```
...
#Code check
c(mean=mean(clim.df[1:19,13]), metric=clim.df[19,29]) #mean() calculation should match metric
```
<br>
