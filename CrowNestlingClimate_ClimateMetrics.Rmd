...
clim.df$MinC8_22 <- dplyr::lead(clim.df$OneCMinusMinC, n = 7)
clim.df$MinC8_22 <- zoo::rollapply(clim.df$Min8_22, width=15, FUN=mean, align = 'left', fill = NA, partial = TRUE, na.rm = TRUE)
