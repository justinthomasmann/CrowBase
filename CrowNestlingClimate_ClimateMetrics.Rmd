...
#add column where daily mean temperatures are set relative to #10C
clim.df$MeanMinus10 <- clim.df$MeanC - 10

#add column where minimum temp relative to 1 C without mean
clim.df$OneMinusMin <- 1 - clim.df$MinC

#make maximum temp relative to 10 C without mean
clim.df$MaxMinus10 <- clim.df$MaxC - 10
