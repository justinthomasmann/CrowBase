...
```{r}
?plot_model
plot_model(F.UBMinInter.mdl, type = "int", mdrt.values = "quart")+
  scale_color_manual(name="Precip Quartiles", values=c("#FFC107","#1E88E5","#D81B60"), breaks =  c(-0.96,-0.44,0.38), labels=c("Upper","Median","Lower"))+
...
UB.fplot <- ggplot(data = F.UB.df)+
    ...
    ggtitle("Parameters affecting upper bill size")+
