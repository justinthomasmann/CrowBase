...
BDTimeModels <- list(MinC1_11.BD.mdl,MinC12_22.BD.mdl,MinC.win.BD.mdl)
BDTimeModelNames <- c('MinC1_11','MinC12_22','MinC.win.BD.mdl')
...
OneCMinusMinC.BW.mdl <- lm(BW ~ OneCMinusMinC12_22 * PrecipSum12_22 + Weight, data = scaled.df, na.action = "na.fail")
```

```{r bill width time 2 model comparison}
BWTime2Models <- list(MinC.BW.mdl,MaxC.BW.mdl,GDD10C.BW.mdl,MaxCMinus10C.BW.mdl,OneCMinusMinC.BW.mdl)
BWTime2ModelNames <- c('MinC','MaxC','GDD10C','MaxCMinus10C','OneCMinusMinC')
