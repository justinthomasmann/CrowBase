...
We want to identify the correct baseline model for the sliding window function to use. The outstanding question is whether the model should include weight AND age or just weight. Anne is concerned that age and weight might be explaining the same variation.
<br>
...
vif(ageWeight.mdl)
vif(ageWeightInter.mdl, type = "predictor")
...
#our climate variables for 1989-2022
...
#make bDate (biological date) for nestling data
